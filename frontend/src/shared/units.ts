...
const BY_SI: Record<string, Display> = {
  ...
  // --- 문헌 카탈로그의 SI 조합 단위 (2026-09-12) ---
  // 서버 `matcore.units` 에 44개 차원이 한꺼번에 들어왔다 — 문헌 정의 77종(값 7,325건)의
  // 단위를 표가 몰라서 그 물성이 사내 항목에 못 이어지고 검색에서 빠져 있었다.
  // 대부분 SI 를 그대로 보인다. 그 분야가 다른 단위로 읽는 셋만 환산한다
  // (파괴인성 MPa·m^0.5 · 활성화에너지 kJ/mol · 유전강도 kV/mm).
  'N/m': { unit: 'N/m', factor: 1, offset: 0 },
  'J/m2': { unit: 'J/m²', factor: 1, offset: 0 },
  'ohm.m': { unit: 'Ω·m', factor: 1, offset: 0 },
  'ohm': { unit: 'Ω', factor: 1, offset: 0 },
  'S/m': { unit: 'S/m', factor: 1, offset: 0 },
  'Pa.s': { unit: 'Pa·s', factor: 1, offset: 0 },
  'eV': { unit: 'eV', factor: 1, offset: 0 },
  'mol/(m.s.Pa)': { unit: 'mol/(m·s·Pa)', factor: 1, offset: 0 },
  'J/mol': { unit: 'kJ/mol', factor: 1e-3, offset: 0 },
  'm2/s': { unit: 'm²/s', factor: 1, offset: 0 },
  'Pa.m0.5': { unit: 'MPa·m^0.5', factor: 1e-6, offset: 0 },
  'V/m': { unit: 'kV/mm', factor: 1e-6, offset: 0 },
  'A/m': { unit: 'A/m', factor: 1, offset: 0 },
  'kg/(m2.s)': { unit: 'kg/(m²·s)', factor: 1, offset: 0 },
  'T': { unit: 'T', factor: 1, offset: 0 },
  'm2/kg': { unit: 'm²/kg', factor: 1, offset: 0 },
  'V': { unit: 'V', factor: 1, offset: 0 },
  'J': { unit: 'J', factor: 1, offset: 0 },
  'kg/mol': { unit: 'kg/mol', factor: 1, offset: 0 },
  'J/m3': { unit: 'J/m³', factor: 1, offset: 0 },
  'K.m2/W': { unit: 'K·m²/W', factor: 1, offset: 0 },
  'm3/kg': { unit: 'm³/kg', factor: 1, offset: 0 },
  'Pa.s/m': { unit: 'Pa·s/m', factor: 1, offset: 0 },
  'J/m': { unit: 'J/m', factor: 1, offset: 0 },
  'dB': { unit: 'dB', factor: 1, offset: 0 },
  'mol/m3': { unit: 'mol/m³', factor: 1, offset: 0 },
  'C/N': { unit: 'C/N', factor: 1, offset: 0 },
  'J/kg': { unit: 'J/kg', factor: 1, offset: 0 },
  'm/cycle': { unit: 'm/cycle', factor: 1, offset: 0 },
  'm2/mol': { unit: 'm²/mol', factor: 1, offset: 0 },
  'mol/(m3.Pa)': { unit: 'mol/(m³·Pa)', factor: 1, offset: 0 },
  'm3/(m2.s)': { unit: 'm³/(m²·s)', factor: 1, offset: 0 },
  'g/600s': { unit: 'g/600s', factor: 1, offset: 0 },
  'kg/(m.s)': { unit: 'kg/(m·s)', factor: 1, offset: 0 },
  'm2/(V.s)': { unit: 'm²/(V·s)', factor: 1, offset: 0 },
  'mol/(m2.s.Pa)': { unit: 'mol/(m²·s·Pa)', factor: 1, offset: 0 },
  'm3/(N.m)': { unit: 'm³/(N·m)', factor: 1, offset: 0 },
  '1/m3': { unit: '1/m³', factor: 1, offset: 0 },
  'kg/m2': { unit: 'kg/m²', factor: 1, offset: 0 },
  'm3/(m2.s.Pa)': { unit: 'm³/(m²·s·Pa)', factor: 1, offset: 0 },
  'm3/mol': { unit: 'm³/mol', factor: 1, offset: 0 },
  'm3/C': { unit: 'm³/C', factor: 1, offset: 0 },
  'm3/(mol.s)': { unit: 'm³/(mol·s)', factor: 1, offset: 0 },
  'W/m2': { unit: 'W/m²', factor: 1, offset: 0 },
}
...
export const SI_BY_DIMENSION: Record<string, string> = {
  ...
  angle: 'rad',
  dimensionless: '1',
  // 문헌 카탈로그의 SI 조합 단위 — 서버 `SI_UNITS` 와 키가 같아야 한다(아키텍처 시험).
  line_force: 'N/m',
  energy_per_area: 'J/m2',
  resistivity: 'ohm.m',
  resistance: 'ohm',
  electric_conductivity: 'S/m',
  viscosity: 'Pa.s',
  photon_energy: 'eV',
  gas_permeability: 'mol/(m.s.Pa)',
  molar_energy: 'J/mol',
  diffusivity: 'm2/s',
  fracture_toughness: 'Pa.m0.5',
  electric_field: 'V/m',
  magnetic_field: 'A/m',
  mass_flux: 'kg/(m2.s)',
  ...
  molar_mass: 'kg/mol',
  energy_density: 'J/m3',
  thermal_resistance: 'K.m2/W',
  specific_volume: 'm3/kg',
  acoustic_impedance: 'Pa.s/m',
  energy_per_length: 'J/m',
  decibel: 'dB',
  concentration: 'mol/m3',
  charge_per_force: 'C/N',
  specific_energy: 'J/kg',
  crack_growth_rate: 'm/cycle',
  molar_absorptivity: 'm2/mol',
  gas_solubility: 'mol/(m3.Pa)',
  volumetric_flux: 'm3/(m2.s)',
  melt_flow_rate: 'g/600s',
  mass_permeability: 'kg/(m.s)',
  carrier_mobility: 'm2/(V.s)',
  gas_permeance: 'mol/(m2.s.Pa)',
  specific_wear_rate: 'm3/(N.m)',
  number_density: '1/m3',
  areal_density: 'kg/m2',
  gas_permeance_volumetric: 'm3/(m2.s.Pa)',
  molar_volume: 'm3/mol',
  hall_coefficient: 'm3/C',
  rate_constant: 'm3/(mol.s)',
  heat_flux: 'W/m2',
}
...
export const UNITS_BY_DIMENSION: Record<string, string[]> = {
  ...
  angle: ['rad', 'deg'],
  dimensionless: ['1'],
  // 문헌 카탈로그의 SI 조합 단위. 정본과, 그 분야가 실제로 쓰는 표기.
  line_force: ['N/m', 'mN/m'],
  energy_per_area: ['J/m2', 'mJ/m2'],
  resistivity: ['ohm.m', 'ohm.cm'],
  resistance: ['ohm'],
  electric_conductivity: ['S/m', 'S/cm'],
  viscosity: ['Pa.s', 'mPa.s', 'cP'],
  photon_energy: ['eV'],
  gas_permeability: ['mol/(m.s.Pa)'],
  molar_energy: ['J/mol', 'kJ/mol'],
  diffusivity: ['m2/s', 'mm2/s'],
  fracture_toughness: ['Pa.m0.5', 'MPa.m0.5'],
  electric_field: ['V/m', 'kV/mm'],
  magnetic_field: ['A/m'],
  mass_flux: ['kg/(m2.s)'],
  magnetic_flux_density: ['T', 'mT'],
  specific_area: ['m2/kg'],
  voltage: ['V'],
  energy: ['J', 'kJ'],
  molar_mass: ['kg/mol', 'g/mol'],
  energy_density: ['J/m3', 'kJ/m3'],
  thermal_resistance: ['K.m2/W'],
  specific_volume: ['m3/kg'],
  acoustic_impedance: ['Pa.s/m'],
  energy_per_length: ['J/m', 'kJ/m'],
  decibel: ['dB'],
  concentration: ['mol/m3'],
  charge_per_force: ['C/N', 'pC/N'],
  specific_energy: ['J/kg', 'kJ/kg'],
  crack_growth_rate: ['m/cycle'],
  molar_absorptivity: ['m2/mol'],
  gas_solubility: ['mol/(m3.Pa)'],
  volumetric_flux: ['m3/(m2.s)'],
  melt_flow_rate: ['g/600s', 'g/10min'],
  mass_permeability: ['kg/(m.s)'],
  carrier_mobility: ['m2/(V.s)'],
  gas_permeance: ['mol/(m2.s.Pa)'],
  specific_wear_rate: ['m3/(N.m)'],
...
export const DIMENSION_LABELS: Record<string, string> = {
  ...
  line_force: '선하중 (박리·택)',
  energy_per_area: '단위면적당 에너지',
  resistivity: '체적저항률',
  resistance: '저항',
  electric_conductivity: '전기전도율',
  viscosity: '점도',
  photon_energy: '준위 에너지',
  gas_permeability: '기체 투과도',
  molar_energy: '몰당 에너지',
  diffusivity: '확산율',
  fracture_toughness: '파괴인성',
  electric_field: '전계 강도',
  magnetic_field: '자계 강도',
  mass_flux: '질량 플럭스',
  ...
  thermal_resistance: '열저항',
  specific_volume: '비체적',
  acoustic_impedance: '음향 임피던스',
  energy_per_length: '길이당 에너지',
  decibel: '데시벨',
  concentration: '농도',
  charge_per_force: '전하/힘 (압전상수)',
  specific_energy: '질량당 에너지',
  crack_growth_rate: '균열성장률',
  molar_absorptivity: '몰흡광계수',
  gas_solubility: '기체 용해도',
  volumetric_flux: '부피 플럭스',
  melt_flow_rate: '용융흐름지수',
  mass_permeability: '질량 투과율',
  carrier_mobility: '캐리어 이동도',
  gas_permeance: '기체 투과계수 (몰)',
  specific_wear_rate: '비마모율',
  number_density: '수밀도',
  areal_density: '단위면적당 질량',
  gas_permeance_volumetric: '기체 투과계수 (부피)',
  molar_volume: '몰부피',
  hall_coefficient: '홀 계수',
  rate_constant: '반응속도상수',
  heat_flux: '열유속',
}
