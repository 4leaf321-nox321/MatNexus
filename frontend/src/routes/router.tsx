 ...
 */
const AccountsAdminPage = lazy(
  () => import("@/modules/accounts/AccountsAdminPage"),
);
...
const FormatProfilesPage = lazy(
  () => import("@/modules/tests/FormatProfilesPage"),
);
...
const WorkspaceHomePage = lazy(
  () => import("@/modules/workspaces/WorkspaceHomePage"),
);
const WorkspacesAdminPage = lazy(
  () => import("@/modules/workspaces/WorkspacesAdminPage"),
);
    ...
    children: [
      { path: "/force-password-change", element: <ForcePasswordChangePage /> },
      {
        ...
        children: [
          ...
          {
            path: "settings/formats/new",
            element: <FormatProfileEditorPage />,
          },
          {
            path: "settings/formats/:key",
            element: <FormatProfileEditorPage />,
          },
