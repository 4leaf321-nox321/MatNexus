...
BUILTIN_VOCABULARIES: list[tuple[str, str, str, int, str | None, str | None]] = [
    ...
    #
    # 이름에 「사내」 가 붙는 이유(2026-09-12): 물성은 세 층으로 산다 — 문헌 물성
    # (카탈로그 키) · 사내 항목(이 축) · 시험이 재는 값. 이름만 보고 어느 층인지
    # 알아야 한다. 이관 `4f60297a1774` 가 기존 DB 의 라벨도 바꿨다.
    ("property_item", "사내 물성 항목", "open", 55, None, None),
