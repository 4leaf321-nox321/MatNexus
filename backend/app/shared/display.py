...
#: 밀도가 **SI(kg/m³)** 인지 가르는 울타리. 에어로젤 1 kg/m³ 부터 오스뮴 22,600 까지가 안이고,
#: 표시 단위(tonne/mm³)로 적은 7.85e-9 나, 7850 을 tonne/mm³ 로 읽은 7.85e15 는 밖이다.
#: 단위가 틀린 밀도는 숫자만 봐서는 안 드러나서 **저장하는 자리마다** 이 울타리를 쓴다 —
#: 카드(적합 모듈)와 재료·시료(재료 모듈)가 함께 쓰므로 여기 둔다.
